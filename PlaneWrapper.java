...
public class PlaneWrapper extends PlaneControl {
    ...
    private BufferedWriter writer;
     ...
     public PlaneWrapper(int arenaSize, int rounds, String binary, String command) {
        super(arenaSize, rounds);
        this.processbuilder = new ProcessBuilder(command, binary, Integer.toString(arenaSize), Integer.toString(rounds));
